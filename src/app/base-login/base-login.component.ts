...
export class BaseLoginComponent implements OnInit {
  ...
  onSubmit(form: any) {
    if (
      ...
      window.sessionStorage.setItem('storage_id', '0001');
      window.sessionStorage.setItem('storage_email', 'admin@gmail.com');
      window.sessionStorage.setItem('storage_role', 'Admin');
      window.sessionStorage.setItem('storage_empid', '0001');
